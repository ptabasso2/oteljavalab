...
```java
[root@pt-instance-1:~/oteljavalab/section05]$ env OTEL_SERVICE_NAME=springotel OTEL_TRACES_EXPORTER=otlp OTEL_METRICS_EXPORTER=otlp OTEL_LOGS_EXPORTER=otlp java -jar solution/build/libs/springtotel-0.0.1-SNAPSHOT.jar
```
...
[root@pt-instance-1:~/oteljavalab/section05]$ env OTEL_SERVICE_NAME=springotel OTEL_TRACES_EXPORTER=logging OTEL_METRICS_EXPORTER=logging OTEL_LOGS_EXPORTER=logging java -jar solution/build/libs/springtotel-0.0.1-SNAPSHOT.jar 
2024-03-06T10:42:23.376Z  INFO 2274086 --- [           main] c.p.o.s.TemperatureApplication           : Starting TemperatureApplication v0.0.1-SNAPSHOT using Java 17.0.9 with PID 2274086 (/root/oteljavalab/section05/solution/build/libs/springtotel-0.0.1-SNAPSHOT.jar started by root in /root/oteljavalab/section05)
...
[root@pt-instance-1:~/oteljavalab/section05]$ env OTEL_SERVICE_NAME=springotel OTEL_TRACES_EXPORTER=otlp OTEL_METRICS_EXPORTER=otlp OTEL_LOGS_EXPORTER=otlp java -jar solution/build/libs/springtotel-0.0.1-SNAPSHOT.jar 
2024-03-06T11:00:33.335Z  INFO 2284901 --- [           main] c.p.o.s.TemperatureApplication           : Starting TemperatureApplication v0.0.1-SNAPSHOT using Java 17.0.9 with PID 2284901 (/root/oteljavalab/section05/solution/build/libs/springtotel-0.0.1-SNAPSHOT.jar started by root in /root/oteljavalab/section05)
